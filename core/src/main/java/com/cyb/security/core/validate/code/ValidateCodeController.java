...
//	private SecurityProperties securityProperties;
	...
	{
		ValidateCode imageCode = smsCodeGenerator.createImageCode(new ServletWebRequest(request));
		sessionStrategy.setAttribute(new ServletWebRequest(request), SESSION_KEY+"SMS", imageCode);
